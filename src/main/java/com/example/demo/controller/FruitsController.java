...
public class FruitsController {
	...
	public String create(@ModelAttribute @Validated User u, BindingResult result, Model model) {
		if (result.hasErrors()) {
	...
	public String update(@ModelAttribute @Validated User u, BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "fruits/change";
		}
